...
function InterimElementProvider() {
  ...
  function InterimElementFactory($document, $q, $rootScope, $timeout, $rootElement, $animate,
                                 $interpolate, $mdCompiler, $mdTheming, $mdUtil) {
    ...
    return function createInterimElementService() {
      ...
      function show(options) {
        var elementId = options.elementId ? options.elementId : 'noname';

      	if (stack.hasOwnProperty(elementId)) {
            return service.cancel(null, elementId).then(function () {
            ...
            stack[elementId] = interimElement;
       ...
       *
       */
      function hide(response, elementId) {
        var elementId = elementId ? elementId : 'noname';
      	var interimElement;
      	if (elementId && stack.hasOwnProperty(elementId)) {
      		interimElement = stack[elementId];
      	}
      	if (interimElement) {
      		delete stack[elementId];
      	}
       ...
       *
       */
      function cancel(reason, elementId) {
        var elementId = elementId ? elementId : 'noname';
      	var interimElement;
      	if (elementId && stack.hasOwnProperty(elementId)) {
      		interimElement = stack[elementId];
